...
def processRequest(ip:int, s:str):
...
def processConnect(ip:int, s:str):
...
def listen_old():
    """Manage already connected sockets and inputs or disconnection requests"""
    global availablePorts
